# -*- coding: utf-8 -*-
with open("frontend/src/components/IndiaMap.jsx", "w", encoding="utf-8") as f:
...
print("Created components/IndiaMap.jsx with interactive vector paths and dynamic tooltips.")
